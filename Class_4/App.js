...
const RestaurantCard = (props) => {
  const { resData } = props;
  const { cuisines, name, costForTwoString, deliveryTime, totalRatingsString } =
    resData?.data;
  return (
    <div className="res-card">
      <img
        src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_292,h_300/TopPicks/FmC1"
        className="res-logo"
      ></img>
      <p>{name}</p>
      <p>{cuisines.join(", ")}</p>
